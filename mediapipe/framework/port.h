...
#if MEDIAPIPE_DISABLE_ONNX
#define MEDIAPIPE_ONNX_ENABLED 0
#else
#define MEDIAPIPE_ONNX_ENABLED 1
#endif

#if defined(WIN32) || defined(_WIN32)
#define MEDIAPIPE_DX_ENABLED 1
#define MEDIAPIPE_DML_ENABLED 1
#else
#define MEDIAPIPE_DX_ENABLED 0
#define MEDIAPIPE_DML_ENABLED 0
#endif
